...
typedef struct {
  ...
  __VL uint32_t CR1;            /*!< SPI Control register 1 (not used in I2S mode),       Address offset: 0x00 */
  __VL uint32_t CR2;            /*!< SPI Control register 2,                              Address offset: 0x04 */
  __VL uint32_t SR;             /*!< SPI Status register,                                 Address offset: 0x08 */
  __VL uint32_t DR;             /*!< SPI data register,                                   Address offset: 0x0C */
  __VL uint32_t CRCPR;          /*!< SPI CRC polynomial register (not used in I2S mode),  Address offset: 0x10 */
  __VL uint32_t RXCRCR;         /*!< SPI Rx CRC register (not used in I2S mode),          Address offset: 0x14 */
  __VL uint32_t TXCRCR;         /*!< SPI Tx CRC register (not used in I2S mode),          Address offset: 0x18 */
  __VL uint32_t I2SCFGR;        /*!< SPI_I2S configuration register,                      Address offset: 0x1C */
  __VL uint32_t I2SPR;          /*!< SPI_I2S prescaler register,                          Address offset: 0x20 */
